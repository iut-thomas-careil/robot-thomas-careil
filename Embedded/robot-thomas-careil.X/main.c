...
{ // Rampe de vitesse
    if(robotState.distanceTelemetreDroit < 25 && robotState.distanceTelemetreCentre < 30 && robotState.distanceTelemetreGauche < 25 && robotState.distanceTelemetreFI < 15 && robotState.distanceTelemetreFN < 15)
        v = 15;
    else if(robotState.distanceTelemetreDroit < 40 && robotState.distanceTelemetreCentre < 50 && robotState.distanceTelemetreGauche < 40 && robotState.distanceTelemetreFI < 30 && robotState.distanceTelemetreFN < 30)
        v = 18;
    else if(robotState.distanceTelemetreDroit >= 40 && robotState.distanceTelemetreCentre >= 50 && robotState.distanceTelemetreGauche >= 40 && robotState.distanceTelemetreFI >= 30 && robotState.distanceTelemetreFN >= 30)
        v = 21;
        LED_BLEUE = 1;
